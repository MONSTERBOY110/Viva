...
PUNCTUATION: never use an em dash or an en dash in any field you return. Use a comma, a colon, parentheses, or a second sentence instead. Ordinary hyphens in compound words are fine.`;
